    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (cmd == "END")
                {
                    Console.WriteLine($"Everyone is safe.{Environment.NewLine}{totalCarsPassed} total cars passed the crossroads.");
                    return;
                }
                ...
                if (cmd=="green")
                {
                    while (greenLight > 0 && carQueue.Count!=0)
                    {
                        ...
                        else
                        {
                            ...
                            if (passSeconds<0)
                            {
                                Console.WriteLine($"A crash happened!{Environment.NewLine} {firstInQueue} was hit at {firstInQueue[firstInQueue.Length+passSeconds]}.");
                                return;
                            }
